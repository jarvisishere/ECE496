...
dateChoice = input('Choose input date: 1.First Day 1, 2.1st Treatment date, 3.15 days after 1st treatment, 4. 5 days before 1st treatment, 5.5 days after 1st treatment :');

% choose patient ID
switch dateChoice
    case 1   
        %input strat at first day
i = 1;
j = i+14;
X = [hemo neut plt]';
X0 = X(:,i:i+j); %X_i
...
EstError(3) = var(errorCal3);
    ...
    case 2
        %input strat at first treatment date
i = firstTreatment;
j = i+14;
X = [hemo neut plt]';
X0 = X(:,i:i+j); %X_i
...
%input strat at 15days after first treatment
i = firstTreatment+15;
j = i+14;
X = [hemo neut plt]';
X0 = X(:,i:i+j); %X_i
